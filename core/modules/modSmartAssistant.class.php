...
class modSmartAssistant extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$smartassistantTopIcon = '<span class=""><img src="'.(defined('DOL_URL_ROOT') ? DOL_URL_ROOT : '').'/custom/smartassistant/img/smartassistant-white.png" style="height:16px;width:16px;vertical-align:text-bottom;margin-top:5px" alt=""></span>';
		$this->menu = array(
			0 => array(
