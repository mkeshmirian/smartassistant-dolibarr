...
class modSmartAssistant extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->module_parts = array('menus' => 1, 'theme' => 0, 'tpl' => 0, 'hooks' => 0, 'moduleforexternal' => 0, 'css' => '/custom/smartassistant/css/smartassistant.css.php', 'js' => 0, 'models' => 0, 'docs' => 0);
		...
		$smartassistantTopIcon = '<span class=""><img src="'.(defined('DOL_URL_ROOT') ? DOL_URL_ROOT : '').'/custom/smartassistant/img/smartassistant-white.png" style="height:16px;width:16px;vertical-align:text-bottom;margin-top:2px" alt=""></span>';
		$this->menu = array(
			0 => array(
